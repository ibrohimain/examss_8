...
const Rules = () => {
    return (
        <div className='2xl:w-[1440px] xl:w-[95%] lg:w-[95%] md:w-[95%] sm:w-[95%] w-[95%] 2xl:h-[400px] xl:h-[400px] lg:h-[400px] md:h-[400px] sm:h-[450px] h-[600px] mx-auto mt-[110px] mb-[50px] 2xl:flex xl:flex lg:flex'>
