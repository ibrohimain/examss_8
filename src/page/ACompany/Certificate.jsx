...
const Certificate = () => {
    ...
    return (
        <div className='w-[100%] h-[550px] mx-auto mt-[10px] '>
            <div className='2xl:w-[1445px] xl:w-[95%] lg:w-[95%] md:w-[95%] sm:w-[95%] w-[95%] h-[100%] 2xl:flex xl:flex lg:flex md:flex  items-center mx-auto'>
                <div className='2xl:w-[30%] xl:w-[20%] lg:w-[20%] md:w-[20%] 2xl:h-[100%] xl:h-[100%] lg:h-[100%] md:h-[100%] h-[25%] p-4 '>
                    <h2 className='text-[30px] font-semibold mt-[25px]'>Сертификаты на продукцию</h2>
                                ...
                                <div className="w-[100%] h-[220px] border rounded-[20px]">
                                    <div className="w-[100%] h-[100%] bg-[white] flex items-center justify-center relative border rounded-[10px] ">
                                        <img
                                            src={item.img}
                                            alt={`Complex ${index + 1}`}
                                            className="w-[90%] h-[90%] object-cover rounded-tr-[20px] rounded-tl-[20px]"
